...
namespace HLTV_CLI {
    ...
    class PlayerOfTheWeek {
        ...
        public void Get(HtmlDocument doc) {
            ...
            HtmlNode box = doc.DocumentNode.SelectSingleNode("//*[@class=\"player-of-the-week-box\"]");
            HtmlNode a = box.SelectSingleNode(".//a[@href]");
            string potwURL = Etc.DEFAULT_URI + a.GetAttributeValue("href", "").Replace("amp;", "");
