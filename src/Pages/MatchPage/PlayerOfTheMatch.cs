...
namespace HLTV_CLI.src
{
    public static class PlayerOfTheMatch
    {
        ...
        {
            HtmlNode potm = docNode.SelectSingleNode("//div[contains(@class,\"highlighted-player\")]");
            string flag = potm.SelectSingleNode(".//img[contains(@class,\"flag\")]").GetAttributeValue("title", "no-flag");
