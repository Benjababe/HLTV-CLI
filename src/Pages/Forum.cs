    ...
    class Forum
    {
        ...
        public void Get(string postURL, bool prompt = false, HtmlNode matchNode = null)
        {
            ...
            if (matchNode == null)
            {
                ...
                Console.WriteLine("\n" + opString[0], Color.HotPink);
                Console.WriteLine(opString[1] + "\n" + opString[2] + "\n");
            }
            ...
            foreach (HtmlNode post in mainPosts)
            {
                ...
                Console.Write(formattedComment[0]);
                Console.WriteLine(formattedComment[1], Color.LightGreen);
                Console.WriteLine(formattedComment[2]);
        ...
        private string[] FormatConsole(string threadSpacer, string[] postString)
        {
            ...
            */
            ...
            string[] ret = { threadSpacer, top, (newContent + bottom + "\n") };
